...
namespace WarMachines.Machines
{
    ...
    public class Pilot : IPilot
    {
        ...
        public override string ToString()
        {
            ...
            int machinesCnt = this.machines.Count;
            tostring += this.Name + " - ";
            if (machinesCnt == 0)
            {
                tostring += "no machines";
            }
            else if (machinesCnt == 1)
            {
                tostring += "1 machine";
            }
            else
            {
                tostring += machinesCnt + " " + "machines";
            }
    ...
    public abstract class Machine : IMachine
    {
        ...
        public string Name
        {
            ...
            set
            {
                if (string.IsNullOrEmpty(value)) throw new ArgumentException("Machine name can not be null or empty!");
                this.name = value;
            }
        }
        ...
        public IPilot Pilot
        {
            ...
            set
            {
                if (null == value) throw new ArgumentNullException("Pilot can not be null!");
                this.pilot = value;
            }
        }
        ...
        public override string ToString()
        {
            ...
            {
                for (int indx = 0; indx < this.Targets.Count; indx++)
                {
                    trgts += this.Targets[indx];
                    if (indx != this.Targets.Count - 1)
                    {
                        trgts += ", ";
                    }
                }
            ...
            var hasDefense = this as Tank;
            if (hasDefense != null)
            {
                if (hasDefense.DefenseMode)
                {
                    defense = "\n *Defense: ON";
                }
                else
            ...
            //stealth mode
            string stealth = string.Empty;
            var hasStealth = this as Fighter;
            if (hasStealth != null)
            {
                if (hasStealth.StealthMode)
                {
                    stealth = "\n *Stealth: ON";
                }
                else
