...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        {
            //DONE: we should remove the previous racket from this.allObjects
            this.allObjects.RemoveAll(o=>o.GetType()==typeof(Racket));
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep((int)this.sleepTime);
