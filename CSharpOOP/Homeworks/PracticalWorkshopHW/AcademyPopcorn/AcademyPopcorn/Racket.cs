...
namespace AcademyPopcorn
{
    public class Racket : GameObject
    {
        ...
        {
            return otherCollisionGroupString == "block" || otherCollisionGroupString == Racket.CollisionGroupString 
                || otherCollisionGroupString == "ball" || otherCollisionGroupString=="gift";
        }
